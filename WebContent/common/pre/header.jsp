...
<div class="soubg">
  <div class="sou">
    <!--Begin 所在收货地区 Begin-->
        ...
        <!--End 所在收货地区 End-->
        <span class="fr">
          <c:if test="${sessionScope.easybuy_user==null}">
          ...
          <c:if test="${sessionScope.easybuy_user!=null}">
            <span class="fl"><a href="${ctx}/admin/user?action=index">${sessionScope.easybuy_user.loginName}</a>&nbsp;|&nbsp;<a href="${ctx}/admin/order?action=index&userId=${sessionScope.loginUser.id}">我的订单</a>&nbsp;</span>
          </c:if>
           <c:if test="${sessionScope.easybuy_user!=null && sessionScope.easybuy_user.type==1}">
            <span class="fl">|&nbsp;<a href="${ctx}/admin/product?action=index&userId=${sessionScope.easybuy_user.id}">后台管理</a>&nbsp;</span>
          </c:if>
           <c:if test="${sessionScope.easybuy_user!=null}">
