				...
				<div class="fresh_left">
					...
					<div class="fresh_txt">
						<div class="fresh_txt_c">
							<c:forEach items="${temp.productCategoryVo}" var="vo">
								<a
									href="${ctx}/ProServlet?mark=queryProductList&category=${vo.productCategory.id}&level=2">${vo.productCategory.name}</a>
							</c:forEach>
						</div>
					</div>
				</div>
					...
					<ul>
						<c:forEach items="${temp.productList}" var="productVo">
							<li>
								...
								<div class="img">
									<a
										href="${ctx}/ProServlet?mark=queryProductDeatil&id=${productVo.id}">
